        ...
        !isGameStarted && (<>
          ...
          <div className=' w-screen p-5 max-w-96'>
            ...
            <div className='flex justify-between gap-2 pt-3'>
              ...
              <button onClick={startGame} className="bg-green-500 flex-1 hover:bg-green-400 text-white font-bold py-2 px-4 border-b-4 border-green-700 hover:green-blue-500 rounded text-xl">Play</button>
            </div>
          </div>
        </>
        )
